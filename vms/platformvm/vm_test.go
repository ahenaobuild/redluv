...
import (
	...
	"github.com/hellobuild/Luv-Go/chains/atomic"
	...
	"github.com/hellobuild/redluv/utils/crypto"
	"github.com/hellobuild/redluv/utils/formatting"
	"github.com/hellobuild/redluv/utils/json"
	"github.com/hellobuild/redluv/utils/logging"
	"github.com/hellobuild/redluv/utils/timer"
	"github.com/hellobuild/redluv/utils/units"
	...
	smcon "github.com/hellobuild/redluv/snow/consensus/snowman"
	smeng "github.com/hellobuild/redluv/snow/engine/snowman"
)
...
var (
	...
	// each key controls an address that has [defaultBalance] LUV at genesis
	keys []*crypto.PrivateKeySECP256K1R

	defaultMinValidatorStake = 5 * units.MilliLuv
	defaultMaxValidatorStake = SupplyCap
	defaultMinDelegatorStake = 1 * units.MilliLuv
...
func defaultGenesis() (*BuildGenesisArgs, []byte) {
	...
	buildGenesisArgs := BuildGenesisArgs{
		...
		InitialSupply: json.Uint64(360 * units.MegaLuv),
	}
