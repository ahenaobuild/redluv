...
// ImportLUV sends an import transaction to import funds from [sourceChain] and
// returns the ID of the newly created transaction
// This is a deprecated name for Import
func (c *Client) ImportLUV(user api.UserPass, to, sourceChain string) (ids.ID, error) {
...
func (c *Client) ExportLUV(
	...
	return c.Export(user, from, changeAddr, amount, to, "LUV")
}
