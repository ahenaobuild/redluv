...
import (
	...
	"github.com/hellobuild/Luv-Go/cache"
	...
	"github.com/hellobuild/Luv-Go/database/versiondb"
	"github.com/hellobuild/redluv/ids"
	"github.com/hellobuild/redluv/pubsub"
	"github.com/hellobuild/redluv/snow"
	"github.com/hellobuild/redluv/snow/choices"
	"github.com/hellobuild/redluv/snow/consensus/snowstorm"
...
func (vm *VM) initGenesis(genesisBytes []byte) error {
	...
	vm.feeAssetID = vm.ctx.LUVAssetID
