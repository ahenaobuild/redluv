...
import (
	...
	"github.com/hellobuild/redluv/coreth/accounts/keystore"
...
func TestMulticoin(t *testing.T) {
	...
	//}
	//counterSrc, err := filepath.Abs(gopath + "/src/github.com/hellobuild/Luv-Go/coreth/examples/multicoin/mc_test.sol")
	//if err != nil {
	// 	t.Fatal(err)
	// }
