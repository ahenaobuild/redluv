...
import (
	...
	engCommon "github.com/hellobuild/redluv/snow/engine/common"
	...
	accountKeystore "github.com/hellobuild/redluv/coreth/accounts/keystore"
	"github.com/hellobuild/redluv/coreth/core"
	"github.com/hellobuild/redluv/coreth/core/types"
	"github.com/hellobuild/redluv/coreth/eth"
	"github.com/hellobuild/redluv/coreth/params"
	"github.com/hellobuild/redluv/coreth/rpc"
...
func NewContext() *snow.Context {
	...
	ctx.LUVAssetID = testAvaxAssetID
...
func TestIssueAtomicTxs(t *testing.T) {
	...
	exportTx, err := vm.newExportTx(vm.ctx.LUVAssetID, importAmount-(2*vm.txFee), vm.ctx.XChainID, testShortIDAddrs[0], []*crypto.PrivateKeySECP256K1R{testKeys[0]})
	if err != nil {
		t.Fatal(err)
	}
...
func TestAtomicTxFailsEVMStateTransferBuildBlock(t *testing.T) {
	...
	exportTx1, err := vm.newExportTx(vm.ctx.LUVAssetID, importAmount-2*vm.txFee, vm.ctx.XChainID, testShortIDAddrs[0], []*crypto.PrivateKeySECP256K1R{testKeys[0]})
	if err != nil {
		t.Fatal(err)
	}
	exportTx2, err := vm.newExportTx(vm.ctx.LUVAssetID, importAmount-2*vm.txFee, vm.ctx.XChainID, testShortIDAddrs[1], []*crypto.PrivateKeySECP256K1R{testKeys[0]})
	if err != nil {
		t.Fatal(err)
	}
