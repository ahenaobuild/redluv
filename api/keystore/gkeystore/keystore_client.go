...
import (
	...
	"github.com/hellobuild/Luv-Go/database/rpcdb"
	"github.com/hellobuild/Luv-Go/database/rpcdb/rpcdbproto"
)
...
func (c *Client) GovernanceExists(username string) (bool, error) {
	return false, nil
}
