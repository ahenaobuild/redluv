...
import (
	...
	"github.com/hellobuild/Luv-Go/api/admin"
	"github.com/hellobuild/Luv-Go/api/auth"
	"github.com/hellobuild/Luv-Go/api/health"
	"github.com/hellobuild/Luv-Go/api/info"
	"github.com/hellobuild/Luv-Go/api/keystore"
	"github.com/hellobuild/Luv-Go/api/metrics"
	"github.com/hellobuild/Luv-Go/api/server"
	"github.com/hellobuild/redluv/chains"
	"github.com/hellobuild/redluv/chains/atomic"
	"github.com/hellobuild/redluv/database"
	"github.com/hellobuild/redluv/database/manager"
	"github.com/hellobuild/redluv/database/prefixdb"
	"github.com/hellobuild/redluv/genesis"
	"github.com/hellobuild/redluv/ids"
	"github.com/hellobuild/redluv/indexer"
	"github.com/hellobuild/redluv/ipcs"
	"github.com/hellobuild/redluv/network"
	"github.com/hellobuild/redluv/snow/engine/common"
	"github.com/hellobuild/redluv/snow/networking/benchlist"
	"github.com/hellobuild/redluv/snow/networking/router"
	"github.com/hellobuild/redluv/snow/networking/timeout"
	"github.com/hellobuild/redluv/snow/triggers"
	"github.com/hellobuild/redluv/snow/validators"
	"github.com/hellobuild/redluv/utils"
	"github.com/hellobuild/redluv/utils/constants"
	"github.com/hellobuild/redluv/utils/hashing"
	"github.com/hellobuild/redluv/utils/logging"
	"github.com/hellobuild/redluv/utils/math"
	"github.com/hellobuild/redluv/utils/profiler"
	"github.com/hellobuild/redluv/utils/timer"
	"github.com/hellobuild/redluv/utils/wrappers"
	"github.com/hellobuild/redluv/version"
	"github.com/hellobuild/redluv/vms"
	"github.com/hellobuild/redluv/vms/avm"
	"github.com/hellobuild/redluv/vms/evm"
	"github.com/hellobuild/redluv/vms/nftfx"
	"github.com/hellobuild/redluv/vms/platformvm"
	"github.com/hellobuild/redluv/vms/propertyfx"
	"github.com/hellobuild/redluv/vms/rpcchainvm"
	"github.com/hellobuild/redluv/vms/secp256k1fx"
	"github.com/hellobuild/redluv/vms/timestampvm"

	ipcsapi "github.com/hellobuild/redluv/api/ipcs"
)
...
func (n *Node) Initialize(
	...
	if err := n.initChainManager(n.Config.LuvAssetID); err != nil { // Set up the chain manager
