...
import (
	...
	"github.com/hellobuild/redluv/utils/password"
	"github.com/hellobuild/redluv/utils/ulimit"
)
...
func GetNodeConfig(v *viper.Viper, buildDir string) (node.Config, error) {
	...
	// Load genesis data
	nodeConfig.GenesisBytes, nodeConfig.LuvAssetID, err = genesis.Genesis(
		networkID,
